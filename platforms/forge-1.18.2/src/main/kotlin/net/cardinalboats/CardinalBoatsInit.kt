    ...
    private fun onClientSetup(event: FMLClientSetupEvent) {
        try {
            ...
            thedarkcolour.kotlinforforge.forge.LOADING_CONTEXT.registerExtensionPoint(IExtensionPoint.DisplayTest::class.java) {
                IExtensionPoint.DisplayTest({ thedarkcolour.kotlinforforge.forge.LOADING_CONTEXT.activeContainer.modInfo.version.toString() }) {
                        _: String?, _: Boolean? -> true
                }
            }

            thedarkcolour.kotlinforforge.forge.LOADING_CONTEXT.registerExtensionPoint(ConfigGuiHandler.ConfigGuiFactory::class.java) {
                ConfigGuiHandler.ConfigGuiFactory { _: Minecraft?, p: net.minecraft.client.gui.screens.Screen? ->
