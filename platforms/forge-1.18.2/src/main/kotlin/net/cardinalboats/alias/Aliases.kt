...
typealias AbstractBoatEntity = Boat
...
var keyMappings: Array<KeyBinding>
    get() {
        return MinecraftClient.getInstance().options.keyMappings
    }
    set(value) {
...
val Entity.steppingBlockState
    get() = this.level.getBlockState(this.getOnPos());

var Entity.yaw
    get() = this.yRot
    set(value) { this.yRot = value }

var AbstractBoatEntity.yawVelocity
    get() = this.deltaRotation //deltaRotation
